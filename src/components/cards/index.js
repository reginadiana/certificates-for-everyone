  ...
  return (
    <div className="div-cards">
      <h1 className="title-1">
        <span className="sub-title-1">Descubra</span> o que o nosso{" "}
        <span className="sub2-title-1">Gerador de Certificados</span> pode fazer
        por você{" "}
      </h1>
      ...
      <div className="site-card-wrapper">
        ...
        <Card className="card" title="Uso empresarial" bordered={false}>
          Crie uma conta para você ou sua comunidade e gere certificados para
          seus eventos e cursos.
        </Card>
