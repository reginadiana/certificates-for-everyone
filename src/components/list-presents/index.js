    ...
    <>
      ...
      >
        ...
        >
          ...
          <Button
            className="buttom-voltar-participants"
        ...
        <div style={{ display: visibleForm ? 'none' : 'block' }}>
          ...
          <Popover
            content={
              <h5>
                Click para enviar certificados para todos os participantes
              </h5>
            }
          >
          ...
          <Popover
            content={
              <h5>Click para cancelar a presença de todos os participantes</h5>
            }
          >
      ...
      <div style={{ display: visible ? 'none' : 'grid' }}>
        ...
        <div className="certificate-background">
          <img
            src={logo}
            alt="Logo da empresa"
            className="img-logo-certificate"
          />
        ...
        <Button className="button-voltar" onClick={() => setVisible(true)}>
