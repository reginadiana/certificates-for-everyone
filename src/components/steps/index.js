...
const Steps = () => (
  <div className="div-steps">
    <h2 className="h2-steps">
      <span className="span-1-steps">Veja como </span>é simples e fácil de usar
      o nosso &nbsp;
      <span className="span-2-steps">passo a passo</span>
    </h2>
    ...
    <h4 className="h4-steps">
      Insira todas as informações necessárias no formulário. Ele ficará salvo
      para nós.
    </h4>
    <h3 className="h3-steps">
